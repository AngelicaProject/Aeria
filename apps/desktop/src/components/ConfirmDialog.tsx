...
type ConfirmDialogProps = {
  ...
  onKeepEditing: () => void;
  onDiscard: () => void;
  /** Labels for other confirmations than discarding edits. */
  confirmLabel?: string;
  cancelLabel?: string;
};

export function ConfirmDialog({ open, message, onKeepEditing, onDiscard, confirmLabel, cancelLabel }: ConfirmDialogProps) {
  const { t } = useI18n();
  return (
